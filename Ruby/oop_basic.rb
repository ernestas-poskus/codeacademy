# Need-to-Know Basis
# You might be wondering why we need to hide information in Ruby. 
# Isn't it okay for every part of your Ruby program to know what every other part is doing?

# Possibly, if you're the only one writing and using your software. 
# But when other people are working on or using your programs, they may attempt to muck around with 
# the way different parts of your program do their jobs. You don't want that!
